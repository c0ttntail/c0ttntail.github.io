...
var size = 480;
var stats = [3, 3, 3, 3, 3]; // Distance, Resourcefulness, Agressiveness, Weight, Movement
var polyHue = 180
var hexSat = 0
var sComp = false
...
function drawPenta() {
    for (let p = 1; p < 6; p++) {
        ...
        chart.lineTo((size*.5 - (6 - p)*size*0.0606298529138), (size*.5 - (6 - p)*size*0.0196998333914));
        chart.lineTo((size*.5 - (6 - p)*size*0.0374713098336), (size*.5 + (6 - p)*size*0.0515748333914));
        chart.lineTo((size*.5 + (6 - p)*size*0.0374713098336), (size*.5 + (6 - p)*size*0.0515748333914))
        chart.lineTo((size*.5 + (6 - p)*size*0.0606298529138), (size*.5 - (6 - p)*size*0.0196998333914))
        chart.closePath();
...
function drawStats() {
    ...
    if (show[3] == true) {
        for (extra of extras) {
            chart.beginPath();
            chart.moveTo((size*.5), (size*.5 - extra[0]*size*.06375));
            chart.lineTo((size*.5 + extra[1]*size*0.0606298529138), (size*.5 - extra[1]*size*0.0196998333914));
            chart.lineTo((size*.5 + extra[2]*size*0.0374713098336), (size*.5 + extra[2]*size*0.0515748333914));
            chart.lineTo((size*.5 - extra[3]*size*0.0374713098336), (size*.5 + extra[3]*size*0.0515748333914))
            chart.lineTo((size*.5 - extra[4]*size*0.0606298529138), (size*.5 - extra[4]*size*0.0196998333914))
            chart.closePath();
            ...
            chart.stroke(); };
        chart.beginPath();
        chart.moveTo((size*.5), (size*.5 - stats[0]*size*.06375));
        chart.lineTo((size*.5 + stats[1]*size*0.0606298529138), (size*.5 - stats[1]*size*0.0196998333914));
        chart.lineTo((size*.5 + stats[2]*size*0.0374713098336), (size*.5 + stats[2]*size*0.0515748333914));
        chart.lineTo((size*.5 - stats[3]*size*0.0374713098336), (size*.5 + stats[3]*size*0.0515748333914))
        chart.lineTo((size*.5 - stats[4]*size*0.0606298529138), (size*.5 - stats[4]*size*0.0196998333914))
        chart.closePath();
...
add.onmousedown = function(event) {
    extras.push([stats[0], stats[1], stats[2], stats[3], stats[4], polyHue]); 
    stats = [3, 3, 3, 3, 3];
    polyHue = 180;
    drawStats(); };
